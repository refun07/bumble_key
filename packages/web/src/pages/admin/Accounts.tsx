    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Accounts & Transactions</h2>
                    <p className="text-gray-500 font-medium">Manage financial records and payouts.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-1">{formatCurrency(stats.total_revenue)}</p>
                </div>
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-4 mb-4">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-1">{formatCurrency(stats.pending_payouts)}</p>
                </div>
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-4 mb-4">
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Completed Payouts</p>
                    <p className="text-3xl font-bold text-gray-900 mt-1">{formatCurrency(stats.completed_payouts)}</p>
                </div>
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-4 mb-4">
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Net Income</p>
                    <p className="text-3xl font-bold text-gray-900 mt-1">{formatCurrency(stats.net_income)}</p>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                    <div className="lg:col-span-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-bumble-yellow/20 focus:border-bumble-yellow outline-none w-64"
                    ...
                    <div>
                        ...
                        <select
                            className="w-full rounded-xl border-gray-300 focus:border-bumble-yellow focus:ring-bumble-yellow"
                            value={filters.type}
